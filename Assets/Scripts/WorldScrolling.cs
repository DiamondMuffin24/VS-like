...
public class WorldScrolling : MonoBehaviour
{
    ...
    Vector2Int currentPlayerTilePositon = new Vector2Int(0, 0);
    ...
    [SerializeField] int terrainTileVerticleCount;
    ...
    private void Awake()
    {
        terrainTiles = new GameObject[terrainTileHorizontalCount, terrainTileVerticleCount];
    }
    ...
    private int CalculatePositionOnAxis(float currentValue, bool horizontal)
    {
        ...
        else
        {
            if (currentValue >= 0)
            {
                currentValue = currentValue % terrainTileVerticleCount;
            }
            else
            {
                currentValue += 1;
                currentValue = terrainTileHorizontalCount -1 + currentValue % terrainTileVerticleCount;
            }
        }
